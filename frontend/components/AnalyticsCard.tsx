...
const AnalyticsCard = ({ title, value, icon, trend }: AnalyticsCardProps) => {
  return (
    <div className="bg-white rounded-xl border-2 border-gray-200 p-6 hover:border-purple-300 hover:shadow-lg transition-all shadow-sm">
      <div className="flex items-center justify-between">
        <div className="flex-1">
          <p className="text-xs font-semibold text-gray-600 mb-3 uppercase tracking-wider" style={{ color: '#4b5563' }}>
            {title}
          </p>
          <p className="text-4xl font-extrabold text-gray-900 mb-2" style={{ color: '#111827' }}>
            {value}
          </p>
          {trend && (
