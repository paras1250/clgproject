...
export default function PersonaInsightPanel({
    ...
    return (
        <div className="w-full h-full bg-white border-r border-gray-200 p-5 space-y-5 overflow-y-auto">
            {/* Persona Insight Header */}
            <div className="flex items-center gap-2 pb-3 border-b border-gray-200">
                <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
                <h3 className="font-bold text-gray-900">Persona Insight</h3>
            </div>

            {/* Active Identity */}
            <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Active Identity</p>
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-4 border border-blue-200 hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="font-bold text-gray-900 truncate">{botName}</p>
                            <p className="text-xs text-gray-600">Online • Replies instantly</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* System Instructions */}
            <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">System Instructions</p>
            ...
            <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Knowledge Base Stats</p>
                <div className="space-y-2">
                    <div className="flex items-center justify-between bg-white rounded-lg p-3 border border-gray-200 hover:shadow-sm transition-shadow">
                    ...
                    <div className="flex items-center justify-between bg-white rounded-lg p-3 border border-gray-200 hover:shadow-sm transition-shadow">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-700">Index Health</span>
                        </div>
                        <span className={`text-lg font-bold ${indexHealth >= 90 ? 'text-green-600' : indexHealth >= 70 ? 'text-yellow-600' : 'text-orange-600'}`}>
                            {indexHealth}%
                        </span>
                    </div>
                    {trainingTextLength > 0 && (
                        <div className="flex items-center justify-between bg-white rounded-lg p-3 border border-gray-200 hover:shadow-sm transition-shadow">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-gray-700">Text Data</span>
                            </div>
