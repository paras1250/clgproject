...
const BackgroundClouds = () => (
    ...
    >
        {/* Left glow — bleeds off the left edge */}
        <div style={{
            position: 'absolute',
            top: '10%',
            left: '-5%',
            width: '35vw',
            height: '70%',
            background: 'radial-gradient(ellipse at left center, #00F5D4 0%, transparent 70%)',
            filter: 'blur(80px)',
            opacity: 0.35,
            borderRadius: '50%',
        }} />
        {/* Right glow — bleeds off the right edge */}
        <div style={{
            position: 'absolute',
            top: '15%',
            right: '-5%',
            width: '35vw',
            height: '75%',
            background: 'radial-gradient(ellipse at right center, #00F5D4 0%, #3A86FF 40%, transparent 70%)',
            filter: 'blur(80px)',
            opacity: 0.35,
            borderRadius: '50%',
        }} />
        ...
        <div style={{
            ...
            width: '60vw',
            height: '50%',
            background: 'radial-gradient(ellipse at center, #00F5D4 0%, transparent 65%)',
            filter: 'blur(120px)',
            opacity: 0.06,
            borderRadius: '50%',
        }} />
...
const ChatbotMockup = () => (
    <div className="relative w-full max-w-[800px] perspective-1000">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[#00F5D4]/10 blur-[100px] -z-20 rounded-full pointer-events-none" />

        {/* ══════════════════════════════════════════════
           Browser Window Container (Relative, NO overflow hidden)
           This holds the chrome bar and the image naturally.
           ══════════════════════════════════════════════ */}
        <div className="relative rounded-xl bg-[#0A0F1C] shadow-2xl shadow-black/60 border border-white/[0.06] ring-1 ring-white/5 z-10 transition-transform duration-500 hover:scale-[1.01] hover:rotate-1">

            {/* Browser Chrome Bar */}
            <div className="bg-[#0F1629] px-4 py-3 flex items-center gap-3 border-b border-white/[0.06] rounded-t-xl">
                ...
                <div className="flex-1 mx-4">
                    <div className="bg-[#0A0F1C] rounded-md px-3 py-1.5 text-xs text-[#64748B] flex items-center gap-2 font-mono border border-white/5">
            ...
            <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-[#0A0F1C] to-transparent opacity-40 pointer-events-none rounded-b-xl" />
        </div>
        ...
        <div className="absolute -bottom-12 -right-8 md:-right-16 w-[280px] md:w-[320px] z-30 filter drop-shadow-2xl animate-float-slow">
            <div className="bg-[#121826] rounded-2xl overflow-hidden border border-white/[0.06] shadow-[0_30px_60px_-10px_rgba(0,0,0,0.8)] flex flex-col">
                {/* Chat header */}
                <div className="bg-[#121826] px-4 py-3 flex items-center gap-3 border-b border-white/[0.06]">
                    <img src="/assets/ai_agent_avatar.png" className="w-8 h-8 rounded-full bg-[#0A0F1C] p-0.5 object-cover ring-2 ring-[#00F5D4]/20" alt="AI Agent" />
                    <div>
                        <span className="text-sm font-semibold text-[#F1F5F9] block leading-tight font-inter">AI Assistant</span>
                        <span className="text-[10px] text-[#10B981] flex items-center gap-1 font-medium"><span className="w-1.5 h-1.5 bg-[#10B981] rounded-full animate-pulse"></span> Online</span>
                    </div>
                ...
                {/* Chat body */}
                <div className="p-4 bg-[#0A0F1C]/95 backdrop-blur-sm flex flex-col gap-3 min-h-[300px]">
                    {/* User question 1 */}
                    <div className="chat-user-1 self-end bg-[#00F5D4] px-3.5 py-2 rounded-2xl rounded-tr-sm max-w-[85%] shadow-lg shadow-[#00F5D4]/10">
                        <p className="text-[#0A0F1C] text-xs leading-relaxed font-semibold font-inter">What do you offer on the menu?</p>
                    </div>

                    {/* AI message 1 */}
                    <div className="chat-msg-1 flex flex-col gap-1 items-start">
                        <div className="bg-[#121826] p-3 rounded-2xl rounded-tl-sm shadow-md border border-white/5 max-w-[92%]">
                        ...
                        <span className="chat-label text-[9px] font-bold text-[#00F5D4] uppercase tracking-wider ml-1 font-inter">Conversio AI Answered</span>
                    </div>

                    {/* User question 2 */}
                    <div className="chat-user-2 self-end bg-[#00F5D4] px-3.5 py-2 rounded-2xl rounded-tr-sm max-w-[85%] shadow-lg shadow-[#00F5D4]/10">
                        <p className="text-[#0A0F1C] text-xs leading-relaxed font-semibold font-inter">Do you have vegetarian options?</p>
                    </div>
        ...
        <div className="absolute -top-12 md:-top-16 -right-4 md:-right-12 z-40 animate-float">
            <div className="relative group cursor-pointer">
                <div className="bg-gradient-to-r from-[#00F5D4] to-[#3A86FF] text-[#0A0F1C] px-5 py-2.5 rounded-full shadow-lg shadow-[#00F5D4]/30 flex items-center gap-2.5 transform rotate-2 group-hover:scale-105 group-hover:-rotate-1 transition-all duration-300 ring-4 ring-[#00F5D4]/10">
                    ...
                    <span className="font-bold text-xs whitespace-nowrap tracking-wide font-inter">You have 1 new conversation!</span>
                    {/* Badge Pointer */}
                    <div className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-4 h-4 bg-[#00F5D4] rotate-45 rounded-sm"></div>
                </div>

                {/* Curved arrow graphic pointing to widget */}
                <svg className="absolute top-10 -left-12 w-20 h-20 text-[#00F5D4] -rotate-12 pointer-events-none hidden md:block opacity-80" viewBox="0 0 100 100" fill="none">
...
const Hero = () => (
    <section className="relative w-full py-10 md:py-24 min-h-[85vh] flex items-center" style={{ overflow: 'visible' }}>
        <BackgroundClouds />
            ...
            <div className="grid lg:grid-cols-[1.1fr_1.3fr] gap-12 items-center w-full">
                <div className="text-left animate-in fade-in slide-in-from-left-8 duration-700 relative">
                    ...
                    <div className="flex flex-col gap-4 max-w-md relative">
                        <Link href="/login"
                            className="noupe-button noupe-button-google py-4 px-6 text-xl relative group bg-[#121826] border border-white/[0.08] rounded-full shadow-sm hover:shadow-md transition-all flex items-center justify-center font-inter"
                        >
                            <span className="absolute left-4 bg-[#121826] p-1 rounded-full">
                        ...
                        <Link href="/login"
                            className="noupe-button noupe-button-primary py-4 px-6 text-xl group bg-[#00F5D4] text-[#0A0F1C] rounded-full hover:bg-[#00D9C0] transition-all flex items-center justify-center font-inter"
                        >
                    ...
                    <div className="absolute -bottom-16 left-32 hidden md:block">
                        <svg className="w-24 h-24 text-[#00F5D4] rotate-12" viewBox="0 0 100 100" fill="none">
...
const Footer = () => (
    <footer className="relative bg-[#0A0F1C] text-white py-24 px-6 overflow-hidden">
        {/* Top Gradient Border */}
        <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#00F5D4]/30 to-transparent"></div>

        {/* Background Glow */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-[#00F5D4]/5 blur-[100px] rounded-full pointer-events-none"></div>
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col items-center gap-12 text-center relative z-10">
            ...
            <div className="w-12 h-[2px] bg-[#121826] rounded-full"></div>

            <div className="max-w-3xl text-sm leading-relaxed text-[#64748B] font-inter">
                <span className="font-semibold text-[#F1F5F9]">Conversio AI</span> is a <Link href="#" className="text-[#00F5D4] hover:text-[#00D9C0] transition-colors relative group">
                    free AI chatbot builder
                    <span className="absolute -bottom-0.5 left-0 w-full h-[1px] bg-[#00F5D4] scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen selection:bg-[#00F5D4]/20 font-sans">
            <Head>
            ...
            {/* ── Header ── */}
            <header className="sticky top-0 z-50 bg-[#0A0F1C]/90 backdrop-blur-md border-b border-white/[0.04]">
                <div className="px-6 lg:px-12 py-5 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <button
                            ...
                            className="w-10 h-10 bg-white/10 rounded-full flex lg:hidden flex-col items-center justify-center gap-[5px] cursor-pointer hover:bg-white/20 transition-all"
                        >
                ...
                {mobileOpen && (
                    <div className="lg:hidden px-6 pb-6 pt-2 flex flex-col gap-4 border-t border-white/[0.06] bg-[#0A0F1C]">
                        ...
                        <Link href="/login"
                            onClick={() => setMobileOpen(false)}
                            className="mt-2 w-full text-center px-6 py-3 bg-[#00F5D4] text-[#0A0F1C] rounded-full hover:bg-[#00D9C0] transition-all font-semibold font-inter text-sm">
                            Sign Up for Free
                        </Link>
                    </div>
                )}
            ...
            <section className="bg-[#0F1629] text-white py-32 px-6 relative overflow-hidden">
                ...
                <div className="max-w-[1300px] mx-auto grid gap-8 md:grid-cols-2">
                    ...
                    <FeatureCard
                        ...
                        bgClass="bg-[#10B981]/[0.03] border-green-500/5 hover:border-green-500/10"
                    />
                    <FeatureCard
                        ...
                        bgClass="bg-[#EF4444]/[0.03] border-red-500/5 hover:border-red-500/10"
                    />
                </div>
            </section>
